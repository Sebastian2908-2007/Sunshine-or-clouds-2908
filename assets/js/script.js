...
var printOneDay = function(weather) {
    ...
    oneDay.innerHTML = "<h2 class='col one-day-title'>" + weather.name +" "+"Today"+ "</h2> <span class='col-12 one-day-span'>temp:"+ " " + weather.main.temp +"</span> <span class='col-12  one-day-span'>wind:" + " " + weather.wind.speed +"</span> <span class='col-12 one-day-span'>humidity:"+ " " + weather.main.humidity +"</span> <span class='col-12  one-day-span'>low temp:"+ " " + weather.main.temp_min +"</span>"
